...
use Vewe\Ui\Theme\Base\Prose\StepsBaseTheme;

final class StepsBaseThemeTest extends TestCase
{    #[Test]
    ...
    public function variant_tests(): void
    {
        ...
        $this->assertSame(
            ...
            StepsBaseTheme::make(props: ['level' => '4'], slot: 'base'),
        );
    }
