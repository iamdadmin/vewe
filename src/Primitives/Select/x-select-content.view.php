...
$attributeString = mkAttrs(new ImmutableArray([
    ...
    'bodyLock' => new MutableString($bodyLock ?? 'false')->match('/^(false|true)$/', default: 'false'),
    ...
    'position' => new MutableString($position ?? 'false')->match('/^(popper|item-aligned)$/', default: 'popper'),
